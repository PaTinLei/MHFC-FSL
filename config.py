...
def config():
    parser = argparse.ArgumentParser('MHFC-FSL')
    parser.add_argument('--folder', type=str, default='/',
                        help='Path to the folder the data is downloaded to.')
    parser.add_argument('--ckpt', type=str, default=None,
                        help='Path to the trained model.')
    parser.add_argument('--eta', type=float, default=1.4, help='eta.')
    parser.add_argument('--resume', type=str, default="ckpt/miniimagenet/x_res12_best.pth.tar")
    parser.add_argument('--r_resume', type=str, default="ckpt/miniimagenet/r_res12_best.pth.tar")
